...
export const CITIES: CityData[] = [
  ...
  // Piemonte
  { name: "Torino", slug: "torino", region: "Piemonte", regionSlug: "piemonte", nearbySlug: ["novara", "asti", "cuneo", "alessandria", "vercelli", "aosta"] },
  ...
  { name: "Biella", slug: "biella", region: "Piemonte", regionSlug: "piemonte", nearbySlug: ["vercelli", "torino", "novara", "verbania", "asti", "aosta"] },
  { name: "Cuneo", slug: "cuneo", region: "Piemonte", regionSlug: "piemonte", nearbySlug: ["torino", "asti", "savona", "alessandria", "imperia"] },
  { name: "Novara", slug: "novara", region: "Piemonte", regionSlug: "piemonte", nearbySlug: ["torino", "milano", "vercelli", "varese", "biella", "aosta"] },
  { name: "Verbania", slug: "verbania", region: "Piemonte", regionSlug: "piemonte", nearbySlug: ["novara", "biella", "vercelli", "varese", "como", "aosta"] },
  { name: "Vercelli", slug: "vercelli", region: "Piemonte", regionSlug: "piemonte", nearbySlug: ["novara", "torino", "biella", "alessandria", "asti", "aosta"] },
  // Liguria
...
export const CITY_CONTEXT: Record<string, string> = {
  "roma": "A Roma il mercato edilizio è dominato da edifici d'epoca nel centro storico — soggetti a vincoli della Soprintendenza — e da condomini anni '50–'70 nei quartieri EUR, Parioli e Tiburtino. I preventivi devono spesso includere costi aggiuntivi per permessi specifici e accessi complessi.",
  "milano": "Milano è il mercato premium per le ristrutturazioni in Italia. Alta concentrazione di condomini anni '60 nelle zone Loreto e Isola, forte domanda di riqualificazione energetica (Ecobonus) e adeguamento sismico. La competizione è elevata e la qualità attesa è superiore alla media nazionale.",
  "napoli": "A Napoli la domanda di ristrutturazioni è intensa: alta densità abitativa, grandi caseggiati nei quartieri periferici e un crescente mercato di riqualificazione nel centro storico UNESCO. L'accessibilità nei vicoli del centro incide significativamente sui costi di cantiere.",
  "torino": "Torino ha un parco edilizio prevalentemente anni '50–'80 con grandi condomini di edilizia popolare nelle periferie est (Falchera, Barriera di Milano). Forte domanda di ristrutturazioni a costo controllato con un mercato meno competitivo rispetto a Milano.",
  "bologna": "Bologna ha la più alta concentrazione di studenti universitari per abitante in Italia: alta rotazione degli affitti e forte domanda di interventi rapidi — bagni, cucine, parquet — con budget contenuto. Il centro storico richiede materiali compatibili con i vincoli comunali.",
  "firenze": "Firenze ha tra i vincoli paesaggistici e urbanistici più severi d'Italia. Le ristrutturazioni nel centro storico richiedono autorizzazioni specifiche, materiali tradizionali (cotto, pietra serena, legno) e tempi più lunghi. Il mercato è ad alto valore medio grazie alla domanda B&B.",
  "genova": "Genova è caratterizzata da morfologia urbana complessa: caruggi stretti nel centro storico e abitazioni su collina con accesso difficile. I preventivi devono includere costi per trasporto materiali in zone a traffico limitato e per interventi strutturali frequenti.",
  "venezia": "A Venezia ogni intervento edilizio richiede pianificazione logistica specifica: i materiali arrivano via acqua e i palazzi storici sono soggetti a vincoli della Soprintendenza. I costi sono mediamente superiori del 30–40% rispetto alla terraferma.",
  "palermo": "Palermo ha un mercato edilizio in forte crescita grazie ai fondi PNRR per la riqualificazione dei quartieri storici. Molte villette anni '60–'80 nel quartiere Libertà necessitano di ristrutturazioni complete. Mercato competitivo con prezzi ancora contenuti rispetto al Centro-Nord.",
  "catania": "Catania ha un parco edilizio in lava basaltica e architettura barocca siciliana. L'alto turnover dei B&B legato al turismo etneo e costiero ha accelerato la domanda di ristrutturazioni di qualità. Forte crescita nel quartiere Ognina e nella zona portuale.",
  "bari": "Bari è in forte espansione edilizia nelle aree Municipio V e Torre a Mare. Alta domanda di ristrutturazioni sia nel centro murattiano (edifici storici) che nelle periferie (villette anni '80). Il mercato immobiliare è in crescita grazie al ruolo di hub logistico del Sud Italia.",
  "verona": "Verona ha un'economia solida legata all'export e al turismo. Forte domanda di ristrutturazioni per B&B e locazioni brevi nel centro storico. Nell'hinterland (Legnago, San Bonifacio) alta richiesta per il distretto manifatturiero e i capannoni industriali.",
  "brescia": "Brescia è la seconda città industriale della Lombardia: forte domanda di ristrutturazioni per capannoni e uffici oltre al residenziale. Il tessuto edilizio anni '70 nella zona ovest necessita di riqualificazione energetica con prezzi inferiori a Milano del 25–30%.",
  "bergamo": "Bergamo ha vissuto una forte espansione residenziale nell'hinterland post-pandemia. Alta richiesta di ristrutturazioni nel borgo storico (Città Alta, vincoli UNESCO) e nel tessuto suburbano di Seriate e Dalmine, con forte spinta allo smart working.",
  "como": "Como ha un mercato immobiliare polarizzato: ville di pregio e residenze storiche sul lungolago, tra le più costose della Lombardia, contro un tessuto più popolare nei quartieri collinari e a Rebbio. Il centro storico murato è soggetto a vincoli della Soprintendenza, mentre il forte turismo internazionale e le seconde case sostengono una domanda costante di ristrutturazioni di alta gamma.",
  "cremona": "Cremona ha un centro storico medievale-rinascimentale di pregio, celebre per la tradizione liutaria, dove gli interventi su edifici vincolati richiedono materiali e tecniche specifiche. Nel resto della città e nella bassa cremonese il patrimonio edilizio è più recente e legato all'agroindustria, con una domanda orientata soprattutto al risparmio energetico.",
  "lecco": "Lecco è stretta tra il lago e le montagne (Grigne, Resegone): il territorio collinare rende più complessi e costosi gli accessi ai cantieri. Il tessuto edilizio combina il centro storico manzoniano con i quartieri dell'ex distretto siderurgico e tessile, oggi in fase di riqualificazione residenziale.",
  "lodi": "Lodi è una città di provincia con un centro storico a portici ben conservato e una crescente pressione abitativa legata alla vicinanza con Milano (linea S1 e A1). Il tessuto edilizio è prevalentemente novecentesco, con una domanda di ristrutturazione trainata da chi si trasferisce dall'hinterland milanese in cerca di prezzi più accessibili.",
  "mantova": "Mantova, patrimonio UNESCO insieme a Sabbioneta, ha un centro rinascimentale — Palazzo Ducale, Palazzo Te e il tessuto storico circostante — soggetto a vincoli paesaggistici stringenti che richiedono materiali tradizionali e tempi più lunghi. Il turismo culturale in crescita alimenta la domanda di ristrutturazioni per B&B e locazioni brevi.",
  "monza": "Monza è ormai parte della conurbazione milanese: alta densità abitativa, forte domanda di riqualificazione energetica nei condomini anni '60-'70 e un mercato sostenuto dalla vicinanza con Milano e dal distretto del mobile della Brianza. La Villa Reale e il centro storico impongono vincoli specifici per gli interventi nelle aree tutelate.",
  "pavia": "Pavia è una città universitaria con una delle sedi accademiche più antiche d'Italia: l'alta rotazione degli affitti studenteschi spinge la domanda di interventi rapidi su bagni, cucine e impianti nei palazzi del centro storico, spesso di origine medievale o rinascimentale. Nell'hinterland agricolo della Lomellina la domanda riguarda più cascine e rustici da riqualificare.",
  "sondrio": "Sondrio e la Valtellina hanno un territorio prevalentemente montano: i cantieri devono fare i conti con pendenze, accessi stretti e una marcata stagionalità legata al turismo (sci in inverno, escursionismo in estate). Il patrimonio edilizio include baite e rustici in pietra da recuperare, oltre a un mercato secondario di seconde case in crescita.",
  "varese": "Varese, la 'città giardino', ha un patrimonio di ville liberty e residenze d'inizio Novecento nei quartieri collinari, oltre a un tessuto più popolare nelle ex aree industriali in riconversione. La vicinanza al confine svizzero e all'aeroporto di Malpensa genera un mercato di frontalieri con buona capacità di spesa per ristrutturazioni di qualità.",
  "trieste": "Trieste ha il patrimonio edilizio asburgico più vasto d'Italia: edifici Liberty e Secessionismo viennese che richiedono restauri specializzati. Crescente domanda di ristrutturazioni legata al porto, alle sedi diplomatiche e ai servizi internazionali della città.",
  "padova": "Padova è il secondo polo universitario del Veneto: alta rotazione degli affitti e forte domanda di upgrade energetico nelle villette anni '70–'80 dei comuni dell'hinterland (Vigonza, Selvazzano, Rubano).",
  "modena": "Modena ha un'economia manifatturiera solida nei distretti ceramica, automotive e Food Valley. Forte domanda di ristrutturazioni di capannoni e spazi commerciali. Nel centro, riqualificazione di condomini anni '60 in prossimità del Duomo UNESCO.",
  "perugia": "Perugia ha un centro storico medievale in pietra che richiede restauri specializzati. Mercato B&B in crescita grazie al turismo enogastronomico umbro. Nell'hinterland (Corciano, Magione) forte domanda residenziale con prezzi accessibili.",
  "salerno": "Salerno è in crescita lungo la costiera amalfitana e cilentana: alta domanda di ristrutturazioni per locazioni brevi e B&B costieri. Il rinnovo del lungomare ha aumentato il valore degli immobili nel centro. Mercato in espansione con buona richiesta di artigiani qualificati.",
  "cagliari": "Cagliari e l'hinterland sardo vivono un boom di ristrutturazioni legate al turismo: immobili da convertire in B&B nei quartieri Marina, Villanova e Castello. Incentivi PNRR e contributi regionali sardi hanno accelerato il mercato della riqualificazione energetica.",
  "ancona": "Ancona è un polo portuale in espansione con forte domanda di ristrutturazioni per attività commerciali legate alla logistica. Nel residenziale, riqualificazione del patrimonio anni '70 in posizione panoramica sulla baia dorica.",
  "reggio-calabria": "Reggio Calabria ha un mercato edilizio in graduale ripresa con incentivi per la riqualificazione del lungomare Falcomatà. Forte domanda di ristrutturazioni legata al turismo dello Stretto. Il parco edilizio è prevalentemente novecentesco.",
  "sassari": "Sassari è il secondo capoluogo sardo con forte crescita nel settore universitario e sanitario. Alta domanda di ristrutturazioni per studentati e abitazioni in affitto. L'hinterland del Sassarese vede espansione residenziale con nuove costruzioni.",
  "messina": "Messina ha subito una storica ricostruzione post-sisma 1908: il parco edilizio è prevalentemente novecentesco con edifici che necessitano di adeguamento sismico. Il turismo dello Stretto e i traghetti per la Calabria sostengono la domanda di ristrutturazioni commerciali.",
  "parma": "Parma ha un'economia solida nel Food Valley e nella manifattura emiliana. Alta domanda di ristrutturazioni per showroom, ristoranti e boutique nel centro storico. Nel residenziale, forte richiesta di upgrade energetico per il patrimonio anni '70.",
  "reggio-emilia": "Reggio Emilia è uno dei motori della manifattura italiana con alta domanda di ristrutturazioni industriali. Il distretto metalmeccanico e ceramico genera forte richiesta di preventivi per capannoni e uffici. Nel residenziale, mercato in crescita con standard qualitativi elevati.",
};
