...
const ProfileExtrasBody = z.object({
  ...
  codiceFiscale: z.string().max(16).nullable().optional(),
  codiceSdi: z.string().max(120).nullable().optional(),
  reaNumber: z.string().max(80).nullable().optional(),
  iban: z.string().max(40).nullable().optional(),
  googleReviewUrl: z.string().url().max(500).nullable().optional(),
  secondaryReviewUrl: z.string().url().max(500).nullable().optional(),
