...
// hashes for the three inline scripts in artifacts/preventivo-ai/index.html
...
const INDEX_HTML = join(ROOT, "artifacts/preventivo-ai/index.html");
const DIST_HTML = join(ROOT, "artifacts/preventivo-ai/dist/public");
