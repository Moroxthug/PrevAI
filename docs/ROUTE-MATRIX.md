...
| Line | Method | Path | Auth | Perm | RL | Val | Gate | Scope | Archived | Token | Webhook |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 93 | GET | `/api/fiscale/profilo` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 139 | PATCH | `/api/fiscale/profilo` | session | fiscale:full | — | zod | hasFeature(fiscal_engine) | n/a | — | — | — |
| 156 | GET | `/api/fiscale/ateco` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 165 | GET | `/api/fiscale/calcolo` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 184 | GET | `/api/fiscale/regole` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 195 | POST | `/api/fiscale/simula` | session | fiscale:view | simulaLimiter | zod | hasFeature(fiscal_engine) | n/a | — | — | — |
| 224 | GET | `/api/fiscale/scadenzario` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 252 | POST | `/api/fiscale/scadenzario/:chiave/versata` | session | fiscale:full | — | zod | hasFeature(fiscal_engine) | predicate | — | — | — |
| 273 | POST | `/api/fiscale/scadenzario/:chiave/riapri` | session | fiscale:full | — | none | hasFeature(fiscal_engine) | predicate | — | — | — |
| 287 | POST | `/api/fiscale/scadenzario/:chiave/quietanza` | session | fiscale:full | — | manual | hasFeature(fiscal_engine) | predicate | — | — | — |
| 326 | GET | `/api/fiscale/scadenzario/:chiave/quietanza/file` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | predicate | — | — | — |
| 350 | DELETE | `/api/fiscale/scadenzario/:chiave/quietanza` | session | fiscale:full | — | none | hasFeature(fiscal_engine) | predicate | — | — | — |
| 370 | GET | `/api/fiscale/scadenzario/:chiave/f24` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | predicate | — | — | — |
| 382 | GET | `/api/fiscale/scadenzario/:chiave/f24.pdf` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | predicate | — | — | — |
| 399 | GET | `/api/fiscale/versamenti` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 431 | POST | `/api/fiscale/versamenti` | session | fiscale:full | — | zod | hasFeature(fiscal_engine) | n/a | — | — | — |
| 452 | DELETE | `/api/fiscale/versamenti/:id` | session | fiscale:full | — | none | hasFeature(fiscal_engine) | predicate | — | — | — |
...
| Line | Method | Path | Auth | Perm | RL | Val | Gate | Scope | Archived | Token | Webhook |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 96 | GET | `/api/fiscale/prima-nota` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 107 | GET | `/api/fiscale/prima-nota.csv` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 126 | POST | `/api/fiscale/prima-nota/movimenti` | session | fiscale:full | — | zod | hasFeature(fiscal_engine) | n/a | — | — | — |
| 139 | DELETE | `/api/fiscale/prima-nota/movimenti/:id` | session | fiscale:full | — | none | hasFeature(fiscal_engine) | predicate | — | — | — |
| 151 | GET | `/api/fiscale/utile` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 160 | GET | `/api/fiscale/banca` | session | fiscale:view | — | zod | hasFeature(fiscal_engine) | n/a | — | — | — |
| 189 | POST | `/api/fiscale/banca/import` | session | fiscale:full | importLimiter | manual | hasFeature(fiscal_engine) | n/a | — | — | — |
| 223 | DELETE | `/api/fiscale/banca/import/:id` | session | fiscale:full | — | none | hasFeature(fiscal_engine) | predicate | — | — | — |
| 235 | POST | `/api/fiscale/banca/abbina-sicuri` | session | fiscale:full | — | manual | hasFeature(fiscal_engine) | n/a | — | — | — |
| 248 | POST | `/api/fiscale/banca/movimenti/:id/:azione` | session | fiscale:full | — | zod | hasFeature(fiscal_engine) | predicate | — | — | — |
| 297 | GET | `/api/fiscale/chiusura` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 305 | GET | `/api/fiscale/chiusura/pacchetto.pdf` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 315 | POST | `/api/fiscale/chiusura/chiudi` | session | fiscale:full | — | zod | hasFeature(fiscal_engine) | n/a | — | — | — |
| 327 | POST | `/api/fiscale/chiusura/riapri` | session | fiscale:full | — | zod | hasFeature(fiscal_engine) | n/a | — | — | — |
| 342 | GET | `/api/fiscale/condivisioni` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | n/a | — | — | — |
| 348 | POST | `/api/fiscale/condivisioni` | session | fiscale:full | — | zod | hasFeature(fiscal_engine) | n/a | — | — | — |
| 367 | GET | `/api/fiscale/condivisioni/:id/accessi` | session | fiscale:view | — | none | hasFeature(fiscal_engine) | predicate | — | — | — |
| 377 | DELETE | `/api/fiscale/condivisioni/:id` | session | fiscale:full | — | none | hasFeature(fiscal_engine) | predicate | — | — | — |
