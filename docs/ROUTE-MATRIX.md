...
| Line | Method | Path | Auth | Perm | RL | Val | Gate | Scope | Archived | Token | Webhook |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 28 | GET | `/api/addons/amministrazione` | session | settings:view | — | none | — | n/a | — | — | — |
| 42 | POST | `/api/addons/amministrazione/eventi` | session | settings:view | — | zod | — | n/a | — | — | — |
| 57 | POST | `/api/addons/amministrazione/checkout` | session | settings:full | checkoutLimiter | zod | — | n/a | — | — | — |
| 71 | GET | `/api/admin/addons/test-prezzo` | admin | — | — | none | — | n/a | — | — | — |
...
| Line | Method | Path | Auth | Perm | RL | Val | Gate | Scope | Archived | Token | Webhook |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 140 | GET | `/api/payments/plans` | none | — | — | none | — | n/a | — | — | — |
| 144 | GET | `/api/payments/trial-status` | session | — | — | none | — | n/a | — | — | — |
| 158 | POST | `/api/payments/checkout` | session | settings:full | — | manual | — | n/a | — | — | — |
| 234 | GET | `/api/payments/subscription` | session | — | — | none | quota-check | n/a | — | — | — |
| 289 | POST | `/api/payments/unlock-quote` | session | quotes:edit | — | manual | — | n/a | — | — | — |
| 339 | POST | `/api/payments/portal` | session | settings:full | — | none | — | n/a | — | — | — |
| 367 | POST | `/api/payments/sync-subscription` | session | settings:full | — | none | — | n/a | — | — | — |
| 474 | GET | `/api/payments/verify/:quoteId` | session | — | — | none | — | post-check | — | — | — |
