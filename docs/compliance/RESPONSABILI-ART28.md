...
| **Intermediario SDI — Openapi.it (default) o A-Cube** | sub-responsabile (trasmissione/ricezione FatturaPA, conservazione a norma) | XML fatture completi, delega, codice destinatario | Italia/UE | — | ⬜ **A-1 (D8)** | Contratto + DPA + manuale di conservazione firmati dal titolare prima di A-1 |
| **Commercialista / studio partner (fase 2)** | **titolare autonomo** per la propria prestazione professionale | quanto condiviso dall'utente | Italia | — | ⬜ **A-6 (D9)** | Accordo di contitolarità/flussi + informativa L. 132/2025; non è un responsabile |
